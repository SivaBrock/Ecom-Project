...
<body>
	...
	<div class="container-fluid">
		<ul class="nav navbar-nav">
			...
			<li cla ss="dropdown"><a class="dropdown-toggle"
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="resources/images/Echo.jpg" alt="Echo ">
				</div>

				<div class="item">
					<img src="resources/images/JBL.jpg" alt="JBL" >
				</div>

				<div class="item">
					<img src="resources/images/Nokia.jpg" alt="Nokia" >
				</div>
			</div>
